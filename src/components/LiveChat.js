...
function LiveChat({ setIsShowChats }) {
  ...
  return (
    <form
      ...
      className="w-[400px]  font-semibold dark:scrollbar-dark  flex overflow-hidden flex-col justify-center items-center rounded-lg  border border-gray-300 dark:border-[--secondary] dark:text-white rounded-b-3xl "
    >
