      ...
      {isShowChats ? (
        ...
        <>
          <button
            ...
            className=" hover:bg-gray-200 mb-3 max-w-[420px] dark:hover:bg-[--primaryGrayDark] dark:text-white dark:border-[--secondary]  mx-3 font-semibold  hover:border-gray-200 w-full  border border-gray-300  p-[6px] rounded-xl"
          >
            Show Live Chats
          </button>
